...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'https://example.con/recipe.pdf'
    ...
    def test_recipe_other_users_recipe_error(self):
        ...
        new_user = create_user(email='user4s@example.com', password='test213')
    ...
    def test_create_recipe_with_exitsting_tags(self):
